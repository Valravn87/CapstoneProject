...
namespace CapstoneProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
			RegisterViewModel reggie = new RegisterViewModel { isOwner = true };
            return View(reggie);
        }
		...
		public ActionResult RegisterManager(int? id, string name = "")
		{
			if (id == null)
			{
				return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
			}
			RegisterViewModel reggie = new RegisterViewModel { isOwner = false, RestaurantId = id,
		...
		private string GeneratePassword()
		{
			...
			pw += rng.Next(0, 10);
			string specialChars = "!@#$%^&*()";
			int charIndex = rng.Next(0, specialChars.Length);
			pw += specialChars[charIndex];
			return pw;
		}
        #endregion
    }
